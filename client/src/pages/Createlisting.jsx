    ...
    const handleImageSubmit = () => {
      ...
      const handleFormSubmit=async(e)=>
      {
        ...
        try {
            ...
            toast({
                title: `${formdata.name} listing created! `,
                status: 'success',
                position:'top-left',
                isClosable: true,
              })
    ...
    <main className=' p-3 max-w-4xl mx-auto'>
      ...
      <form onSubmit={handleFormSubmit} className='flex flex-col sm:flex-row gap-6'>
        ...
        <div className='flex flex-wrap gap-6'>
            ...
            <div className='flex items-center gap-2'>
                <input onChange={handleChange} value={formdata.regularPrice} type='number' id='regularPrice'  required className='p-3 border border-gray-300 rounded-xl'/>
            ...
            </div>
            {
                formdata.offer&&(
                    <div className='flex items-center gap-2'>
                    <input onChange={handleChange} value={formdata.discountPrice} type='number' id='discountPrice' required className='p-3 border border-gray-300 rounded-xl'/>
                    <div className='flex flex-col items'>
        ...
        <div className='flex flex-col flex-1 gap-4'>
          ...
          </p>
          {
            ...
            <button disabled={loading} type='submit' className='p-3 mt-2 bg-slate-900 text-white rounded-lg uppercase hover:opacity-95'>{loading ? 'Creating...':'Create Listing'}</button>
            {
